...
export async function POST(req: NextRequest) {
  const { total, byType, topGenres, topVibes, byFeeling, topCreators } = await req.json()
...
Write 2-3 sentences that feel like a genuine insight into this person's taste — not just a summary of the numbers. Find a pattern, make a specific observation, say something they might not have noticed about themselves. Be direct and specific. No fluff, no "based on your data". Just speak to them like you know their taste.`
